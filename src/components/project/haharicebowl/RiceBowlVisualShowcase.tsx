        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[220px]">
          ...
          <div className="flex flex-col gap-4 md:col-span-1 md:row-span-2">
            <div className="h-full bg-[#262626] rounded-3xl border-2 border-[#333] relative overflow-hidden group">
                ...
                <img src="/images/project/haharicebowl/logo-macro.jpg" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
            </div>
            <div className="h-full bg-[#262626] rounded-3xl border-2 border-[#333] relative overflow-hidden group">
                ...
                <img src="/images/project/haharicebowl/logo-micro.jpg" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
            </div>
          </div>
          ...
          <div className="md:col-span-2 md:row-span-2 bg-[#262626] rounded-[2.5rem] border-2 border-[#333] relative overflow-hidden group">
            ...
            <img src="/images/project/haharicebowl/mockup-cart.jpg" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
          </div>
          ...
          <div className="md:col-span-1 md:row-span-2 bg-[#262626] rounded-[2.5rem] border-2 border-[#EF4444] relative overflow-hidden group">
            ...
            <img src="/images/project/haharicebowl/mockup-banner.jpg" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-1000" />
          </div>
          ...
          <div className="md:col-span-1 md:row-span-2 bg-[#262626] rounded-3xl border-2 border-[#333] relative overflow-hidden group">
            ...
            <img src="/images/project/haharicebowl/menu-1.jpg" className="w-full h-full object-cover group-hover:scale-105" />
          </div>
          ...
          <div className="md:col-span-1 md:row-span-2 bg-[#262626] rounded-3xl border-2 border-[#333] relative overflow-hidden group">
            ...
            <img src="/images/project/haharicebowl/menu-2.jpg" className="w-full h-full object-cover group-hover:scale-105" />
          </div>
          ...
          <div className="md:col-span-1 md:row-span-2 bg-[#262626] rounded-3xl border-2 border-[#333] relative overflow-hidden group">
            ...
            <img src="/images/project/haharicebowl/pamphlet.jpg" className="w-full h-full object-cover group-hover:scale-105" />
          </div>
          ...
          <div className="flex flex-col gap-4 md:col-span-1 md:row-span-2">
            <div className="h-full bg-[#262626] rounded-3xl border-2 border-[#333] relative overflow-hidden group">
                ...
                <img src="/images/project/haharicebowl/mockup-box-1.jpg" className="w-full h-full object-cover group-hover:scale-110" />
            </div>
            <div className="h-full bg-[#262626] rounded-3xl border-2 border-[#333] relative overflow-hidden group">
                ...
                <img src="/images/project/haharicebowl/mockup-box-2.jpg" className="w-full h-full object-cover group-hover:scale-110" />
            </div>
          </div>
